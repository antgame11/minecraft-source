...
public class OceanRuinGenerator {
    ...
    extends SimpleStructurePiece {
        ...
        public static Piece fromNbt(StructureTemplateManager structureTemplateManager, NbtCompound nbt) {
            BlockRotation lv = nbt.get("Rot", BlockRotation.ENUM_NAME_CODEC).orElseThrow();
            float f = nbt.getFloat("Integrity", 0.0f);
            OceanRuinStructure.BiomeTemperature lv2 = nbt.get("BiomeType", OceanRuinStructure.BiomeTemperature.ENUM_NAME_CODEC).orElseThrow();
