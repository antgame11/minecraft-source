...
public class MineshaftGenerator {
            ...
            while (bl || bl2) {
                ...
                if (bl2) {
                    ...
                    if (!bl3 && this.sideCoversSmallSquare(world, lv, lv2)) {
                        ...
                        MineshaftCorridor.fillColumn(world, Blocks.IRON_CHAIN.getDefaultState(), lv, l + 2, l + m);
                        return;
                    }
    ...
    extends StructurePiece {
        ...
        public MineshaftPart(StructurePieceType arg, NbtCompound arg2) {
            super(arg, arg2);
            this.mineshaftType = MineshaftStructure.Type.byId(arg2.getInt("MST", 0));
        }
        ...
        protected boolean canAddBlock(WorldView world, int x, int y, int z, BlockBox box) {
            ...
            return !lv.isOf(this.mineshaftType.getPlanks().getBlock()) && !lv.isOf(this.mineshaftType.getLog().getBlock()) && !lv.isOf(this.mineshaftType.getFence().getBlock()) && !lv.isOf(Blocks.IRON_CHAIN);
        }
