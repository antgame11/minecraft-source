...
public class OceanMonumentGenerator {
    ...
    implements PieceFactory {
        ...
        public boolean canGenerate(PieceSetting setting) {
            if (setting.neighborPresences[Direction.NORTH.getIndex()] && !setting.neighbors[Direction.NORTH.getIndex()].used && setting.neighborPresences[Direction.UP.getIndex()] && !setting.neighbors[Direction.UP.getIndex()].used) {
                PieceSetting lv = setting.neighbors[Direction.NORTH.getIndex()];
                return lv.neighborPresences[Direction.UP.getIndex()] && !lv.neighbors[Direction.UP.getIndex()].used;
            }
            return false;
        }
    ...
    implements PieceFactory {
        ...
        public boolean canGenerate(PieceSetting setting) {
            if (setting.neighborPresences[Direction.EAST.getIndex()] && !setting.neighbors[Direction.EAST.getIndex()].used && setting.neighborPresences[Direction.UP.getIndex()] && !setting.neighbors[Direction.UP.getIndex()].used) {
                PieceSetting lv = setting.neighbors[Direction.EAST.getIndex()];
                return lv.neighborPresences[Direction.UP.getIndex()] && !lv.neighbors[Direction.UP.getIndex()].used;
            }
            return false;
        }
    ...
    implements PieceFactory {
        ...
        public Piece generate(Direction direction, PieceSetting setting, Random random) {
            ...
            if (!setting.neighborPresences[Direction.NORTH.getIndex()] || setting.neighbors[Direction.NORTH.getIndex()].used) {
                lv = setting.neighbors[Direction.SOUTH.getIndex()];
            }
            lv.used = true;
            lv.neighbors[Direction.NORTH.getIndex()].used = true;
    ...
    extends Piece {
        ...
        public void generate(StructureWorldAccess world, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox chunkBox, ChunkPos chunkPos, BlockPos pivot) {
            BlockState lv5;
            int i;
            PieceSetting lv = this.setting.neighbors[Direction.NORTH.getIndex()];
            PieceSetting lv2 = this.setting;
            PieceSetting lv3 = lv.neighbors[Direction.UP.getIndex()];
            PieceSetting lv4 = lv2.neighbors[Direction.UP.getIndex()];
            if (this.setting.roomIndex / 25 > 0) {
                this.generateVerticalConnection(world, chunkBox, 0, 8, lv.neighborPresences[Direction.DOWN.getIndex()]);
                this.generateVerticalConnection(world, chunkBox, 0, 0, lv2.neighborPresences[Direction.DOWN.getIndex()]);
            }
            if (lv4.neighbors[Direction.UP.getIndex()] == null) {
                this.fillArea(world, chunkBox, 1, 8, 1, 6, 8, 7, PRISMARINE);
            }
            if (lv3.neighbors[Direction.UP.getIndex()] == null) {
            ...
            if (lv2.neighborPresences[Direction.SOUTH.getIndex()]) {
                this.setAirAndWater(world, chunkBox, 3, 1, 0, 4, 2, 0);
            }
            if (lv2.neighborPresences[Direction.EAST.getIndex()]) {
                this.setAirAndWater(world, chunkBox, 7, 1, 3, 7, 2, 4);
            }
            if (lv2.neighborPresences[Direction.WEST.getIndex()]) {
                this.setAirAndWater(world, chunkBox, 0, 1, 3, 0, 2, 4);
            }
            if (lv.neighborPresences[Direction.NORTH.getIndex()]) {
                this.setAirAndWater(world, chunkBox, 3, 1, 15, 4, 2, 15);
            }
            if (lv.neighborPresences[Direction.WEST.getIndex()]) {
                this.setAirAndWater(world, chunkBox, 0, 1, 11, 0, 2, 12);
            }
            if (lv.neighborPresences[Direction.EAST.getIndex()]) {
                this.setAirAndWater(world, chunkBox, 7, 1, 11, 7, 2, 12);
            }
            if (lv4.neighborPresences[Direction.SOUTH.getIndex()]) {
                this.setAirAndWater(world, chunkBox, 3, 5, 0, 4, 6, 0);
            }
            if (lv4.neighborPresences[Direction.EAST.getIndex()]) {
            ...
            if (lv4.neighborPresences[Direction.WEST.getIndex()]) {
            ...
            if (lv3.neighborPresences[Direction.NORTH.getIndex()]) {
                this.setAirAndWater(world, chunkBox, 3, 5, 15, 4, 6, 15);
            }
            if (lv3.neighborPresences[Direction.WEST.getIndex()]) {
            ...
            if (lv3.neighborPresences[Direction.EAST.getIndex()]) {
    ...
    extends Piece {
        ...
        @Override
        public void generate(StructureWorldAccess world, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox chunkBox, ChunkPos chunkPos, BlockPos pivot) {
            PieceSetting lv = this.setting.neighbors[Direction.EAST.getIndex()];
            PieceSetting lv2 = this.setting;
            PieceSetting lv3 = lv2.neighbors[Direction.UP.getIndex()];
            PieceSetting lv4 = lv.neighbors[Direction.UP.getIndex()];
            if (this.setting.roomIndex / 25 > 0) {
                this.generateVerticalConnection(world, chunkBox, 8, 0, lv.neighborPresences[Direction.DOWN.getIndex()]);
                this.generateVerticalConnection(world, chunkBox, 0, 0, lv2.neighborPresences[Direction.DOWN.getIndex()]);
            }
            if (lv3.neighbors[Direction.UP.getIndex()] == null) {
            ...
            if (lv2.neighborPresences[Direction.NORTH.getIndex()]) {
                this.setAirAndWater(world, chunkBox, 3, 1, 7, 4, 2, 7);
            }
            if (lv2.neighborPresences[Direction.WEST.getIndex()]) {
                this.setAirAndWater(world, chunkBox, 0, 1, 3, 0, 2, 4);
            }
            if (lv.neighborPresences[Direction.SOUTH.getIndex()]) {
            ...
            if (lv3.neighborPresences[Direction.SOUTH.getIndex()]) {
                this.setAirAndWater(world, chunkBox, 3, 5, 0, 4, 6, 0);
            }
            if (lv3.neighborPresences[Direction.NORTH.getIndex()]) {
            ...
            if (lv4.neighborPresences[Direction.NORTH.getIndex()]) {
    ...
    extends Piece {
        ...
        public void generate(StructureWorldAccess world, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox chunkBox, ChunkPos chunkPos, BlockPos pivot) {
            ...
            if (lv2.neighbors[Direction.UP.getIndex()] == null) {
                this.fillArea(world, chunkBox, 1, 4, 1, 6, 4, 7, PRISMARINE);
            }
            if (lv.neighbors[Direction.UP.getIndex()] == null) {
    ...
    extends Piece {
        ...
        public void generate(StructureWorldAccess world, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox chunkBox, ChunkPos chunkPos, BlockPos pivot) {
            ...
            PieceSetting lv = this.setting.neighbors[Direction.UP.getIndex()];
            if (lv.neighbors[Direction.UP.getIndex()] == null) {
