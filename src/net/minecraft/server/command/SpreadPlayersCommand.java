...
public class SpreadPlayersCommand {
    ...
    private static int execute(ServerCommandSource source, Vec2f center, float spreadDistance, float maxRange, int maxY, boolean respectTeams, Collection<? extends Entity> targets) throws CommandSyntaxException {
        ...
        Pile[] lvs = SpreadPlayersCommand.makePiles(lv2, respectTeams ? SpreadPlayersCommand.getPileCountRespectingTeams(targets) : targets.size(), d, e, h, k);
        SpreadPlayersCommand.spread(center, spreadDistance, lv, lv2, d, e, h, k, maxY, lvs, respectTeams);
        double l = SpreadPlayersCommand.teleport(targets, lv, lvs, maxY, respectTeams);
