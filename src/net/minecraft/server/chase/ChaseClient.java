...
public class ChaseClient {
    ...
    private void executeCommand(String command) {
        this.minecraftServer.execute(() -> {
            ...
            ServerCommandSource lv3 = new ServerCommandSource(lv.getCommandOutput(), Vec3d.of(lv2.getSpawnPoint().getPos()), Vec2f.ZERO, lv2, 4, "", ScreenTexts.EMPTY, this.minecraftServer, lv);
            CommandManager lv4 = this.minecraftServer.getCommandManager();
            lv4.parseAndExecute(lv3, command);
        });
    }
