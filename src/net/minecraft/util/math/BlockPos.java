...
extends Vec3i {
    ...
    public static Iterable<BlockPos> method_73159(Box arg, Vec3d arg2) {
        Vec3d lv = arg.getMinPos();
        int i = MathHelper.floor(lv.getX());
        int j = MathHelper.floor(lv.getY());
        int k = MathHelper.floor(lv.getZ());
        Vec3d lv2 = arg.getMaxPos();
        int l = MathHelper.floor(lv2.getX());
        int m = MathHelper.floor(lv2.getY());
        int n = MathHelper.floor(lv2.getZ());
        return BlockPos.method_73158(i, j, k, l, m, n, arg2);
    }

    public static Iterable<BlockPos> method_73160(BlockPos arg, BlockPos arg2, Vec3d arg3) {
        return BlockPos.method_73158(arg.getX(), arg.getY(), arg.getZ(), arg2.getX(), arg2.getY(), arg2.getZ(), arg3);
    }

    public static Iterable<BlockPos> method_73158(int i, int j, int k, int l, int m, int n, Vec3d arg) {
        int o = Math.min(i, l);
        int p = Math.min(j, m);
        int q = Math.min(k, n);
        int r = Math.max(i, l);
        ...
        int v = s - p;
        int w = t - q;
        final int x = arg.x >= 0.0 ? o : r;
        final int y = arg.y >= 0.0 ? p : s;
        final int z = arg.z >= 0.0 ? q : t;
        ImmutableList<Direction.Axis> list = Direction.method_73163(arg);
        Direction.Axis lv = (Direction.Axis)list.get(0);
        Direction.Axis lv2 = (Direction.Axis)list.get(1);
        Direction.Axis lv3 = (Direction.Axis)list.get(2);
        final Direction lv4 = arg.getComponentAlongAxis(lv) >= 0.0 ? lv.getPositiveDirection() : lv.getNegativeDirection();
        final Direction lv5 = arg.getComponentAlongAxis(lv2) >= 0.0 ? lv2.getPositiveDirection() : lv2.getNegativeDirection();
        final Direction lv6 = arg.getComponentAlongAxis(lv3) >= 0.0 ? lv3.getPositiveDirection() : lv3.getNegativeDirection();
        final int aa = lv.choose(u, v, w);
        final int ab = lv2.choose(u, v, w);
        final int ac = lv3.choose(u, v, w);
        return () -> new AbstractIterator<BlockPos>(){
            private final Mutable field_61950 = new Mutable();
            private int field_61951;
            private int field_61952;
            private int field_61953;
            private boolean field_61954;
            private final int field_61955 = lv4.getOffsetX();
            private final int field_61956 = lv4.getOffsetY();
            private final int field_61957 = lv4.getOffsetZ();
            private final int field_61958 = lv5.getOffsetX();
            private final int field_61959 = lv5.getOffsetY();
            private final int field_61960 = lv5.getOffsetZ();
            private final int field_61961 = lv6.getOffsetX();
            private final int field_61962 = lv6.getOffsetY();
            private final int field_61963 = lv6.getOffsetZ();
            ...
            protected BlockPos computeNext() {
                ...
                this.field_61950.set(x + this.field_61955 * this.field_61951 + this.field_61958 * this.field_61952 + this.field_61961 * this.field_61953, y + this.field_61956 * this.field_61951 + this.field_61959 * this.field_61952 + this.field_61962 * this.field_61953, z + this.field_61957 * this.field_61951 + this.field_61960 * this.field_61952 + this.field_61963 * this.field_61953);
                if (this.field_61953 < ac) {
                    ++this.field_61953;
                } else if (this.field_61952 < ab) {
                    ++this.field_61952;
                    this.field_61953 = 0;
                } else if (this.field_61951 < aa) {
                    ++this.field_61951;
                    this.field_61953 = 0;
                    this.field_61952 = 0;
                } else {
                    this.field_61954 = true;
                }
                return this.field_61950;
            }
