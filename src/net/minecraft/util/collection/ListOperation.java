...
public interface ListOperation {
    ...
    public record ReplaceSection(int offset, Optional<Integer> size) implements ListOperation
    {
        ...
        public static final MapCodec<ReplaceSection> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(Codecs.NON_NEGATIVE_INT.optionalFieldOf("offset", 0).forGetter(ReplaceSection::offset), Codecs.NON_NEGATIVE_INT.optionalFieldOf("size").forGetter(ReplaceSection::size)).apply((Applicative<ReplaceSection, ?>)instance, ReplaceSection::new));
    ...
    {
        private static final Logger LOGGER = LogUtils.getLogger();
        public static final MapCodec<Insert> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(Codecs.NON_NEGATIVE_INT.optionalFieldOf("offset", 0).forGetter(Insert::offset)).apply((Applicative<Insert, ?>)instance, Insert::new));
