...
public final class Path {
    public static final PacketCodec<PacketByteBuf, Path> PACKET_CODEC = PacketCodec.ofStatic((buf, path) -> path.toBuf((PacketByteBuf)buf), Path::fromBuf);
    ...
    public boolean equals(Object o) {
        ...
        Path lv = (Path)o;
        return this.currentNodeIndex == lv.currentNodeIndex && this.debugNodeInfos == lv.debugNodeInfos && this.reachesTarget == lv.reachesTarget && this.target.equals(lv.target) && this.nodes.equals(lv.nodes);
    }
