...
public abstract class EntityNavigation {
    ...
    public EntityNavigation(MobEntity entity, World world) {
        ...
        if (world instanceof ServerWorld) {
            ...
            SubscriberTracker lv2 = lv.getServer().getSubscriberTracker();
            this.pathNodeNavigator.setShouldSendDebugData(() -> lv2.hasSubscriber(DebugSubscriptionTypes.ENTITY_PATHS));
        }
    }
    ...
    protected static boolean doesNotCollide(MobEntity entity, Vec3d startPos, Vec3d entityPos, boolean includeFluids) {
        ...
        return entity.getEntityWorld().raycast(new RaycastContext(startPos, lv, RaycastContext.ShapeType.COLLIDER, includeFluids ? RaycastContext.FluidHandling.ANY : RaycastContext.FluidHandling.NONE, entity)).getType() == HitResult.Type.MISS;
    }
