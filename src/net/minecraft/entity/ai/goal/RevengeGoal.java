...
extends TrackTargetGoal {
    ...
    protected void callSameTypeForRevenge() {
        ...
        Box lv = Box.from(this.mob.getEntityPos()).expand(d, 10.0, d);
        List<Entity> list = this.mob.getEntityWorld().getEntitiesByClass(this.mob.getClass(), lv, EntityPredicates.EXCEPT_SPECTATOR);
