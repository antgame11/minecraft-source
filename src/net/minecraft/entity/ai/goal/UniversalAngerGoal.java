...
extends Goal {
    ...
    private List<? extends MobEntity> getOthersInRange() {
        ...
        Box lv = Box.from(((Entity)this.mob).getEntityPos()).expand(d, 10.0, d);
        return ((Entity)this.mob).getEntityWorld().getEntitiesByClass(this.mob.getClass(), lv, EntityPredicates.EXCEPT_SPECTATOR);
    }
}
