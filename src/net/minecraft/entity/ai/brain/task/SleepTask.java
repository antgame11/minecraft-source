...
extends MultiTickTask<LivingEntity> {
    ...
    protected boolean shouldRun(ServerWorld world, LivingEntity entity) {
        ...
        return lv2.pos().isWithinDistance(entity.getEntityPos(), 2.0) && lv3.isIn(BlockTags.BEDS) && lv3.get(BedBlock.OCCUPIED) == false;
    }
    ...
    protected boolean shouldKeepRunning(ServerWorld world, LivingEntity entity, long time) {
        ...
        return entity.getBrain().hasActivity(Activity.REST) && entity.getY() > (double)lv.getY() + 0.4 && lv.isWithinDistance(entity.getEntityPos(), 1.14);
    }
