...
extends MultiTickTask<FrogEntity> {
    ...
    protected void run(ServerWorld arg, FrogEntity arg2, long l) {
        ...
        arg2.getBrain().remember(MemoryModuleType.WALK_TARGET, new WalkTarget(lv.getEntityPos(), 2.0f, 0));
        ...
        switch (this.phase.ordinal()) {
            case 0: {
                if (lv.distanceTo(arg2) < 1.75f) {
                    ...
                    lv.setVelocity(lv.getEntityPos().relativize(arg2.getEntityPos()).normalize().multiply(0.75));
                    this.targetPos = lv.getEntityPos();
                    this.eatTick = 0;
