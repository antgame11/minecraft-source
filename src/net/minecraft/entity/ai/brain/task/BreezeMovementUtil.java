...
public class BreezeMovementUtil {
    ...
    public static Vec3d getRandomPosBehindTarget(LivingEntity target, Random random) {
        ...
        return target.getEntityPos().add(lv);
    }
    ...
    public static boolean canMoveTo(BreezeEntity breeze, Vec3d pos) {
        ...
        return breeze.getEntityWorld().raycast(new RaycastContext(lv, pos, RaycastContext.ShapeType.COLLIDER, RaycastContext.FluidHandling.NONE, breeze)).getType() == HitResult.Type.MISS;
    }
