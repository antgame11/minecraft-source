...
extends MultiTickTask<AnimalEntity> {
    ...
    protected void run(ServerWorld arg, AnimalEntity arg2, long l) {
        ...
        TargetUtil.lookAtAndWalkTowardsEachOther(arg2, lv, this.speed, this.approachDistance);
    ...
    protected boolean shouldKeepRunning(ServerWorld arg, AnimalEntity arg2, long l) {
        ...
        return lv.isAlive() && arg2.canBreedWith(lv) && TargetUtil.canSee(arg2.getBrain(), lv) && l <= this.breedTime && !arg2.isPanicking() && !lv.isPanicking();
    }
