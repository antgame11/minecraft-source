...
extends MultiTickTask<E> {
    ...
    protected void run(ServerWorld arg, PathAwareEntity arg2, long l) {
        ...
        lv.getOptionalRegisteredMemory(MemoryModuleType.VISIBLE_MOBS).flatMap(mobs -> mobs.findFirst(mob -> this.targetPredicate.test(arg, arg2, (LivingEntity)mob))).ifPresent(mob -> this.findRam(arg2, (LivingEntity)mob));
    }
