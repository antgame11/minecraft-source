...
extends MultiTickTask<VillagerEntity> {
    ...
    protected boolean shouldRun(ServerWorld arg, VillagerEntity arg2) {
        ...
        if (!arg2.getVillagerData().profession().matchesKey(VillagerProfession.FARMER)) {
            return false;
        }
    ...
    protected void keepRunning(ServerWorld arg, VillagerEntity arg2, long l) {
        if (this.currentTarget != null && !this.currentTarget.isWithinDistance(arg2.getEntityPos(), 1.0)) {
            return;
        }
