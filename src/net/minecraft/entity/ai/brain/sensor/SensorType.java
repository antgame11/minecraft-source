...
public class SensorType<U extends Sensor<?>> {
    ...
    public static final SensorType<TemptationsSensor> HAPPY_GHAST_TEMPTATIONS = SensorType.register("happy_ghast_temptations", () -> new TemptationsSensor(HappyGhastEntity.FOOD_PREDICATE));
