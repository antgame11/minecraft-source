...
public record EquipmentTable(RegistryKey<LootTable> lootTable, Map<EquipmentSlot, Float> slotDropChances) {
    ...
    public static final Codec<EquipmentTable> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)LootTable.TABLE_KEY.fieldOf("loot_table")).forGetter(EquipmentTable::lootTable), SLOT_DROP_CHANCES_CODEC.optionalFieldOf("slot_drop_chances", Map.of()).forGetter(EquipmentTable::slotDropChances)).apply((Applicative<EquipmentTable, ?>)instance, EquipmentTable::new));
