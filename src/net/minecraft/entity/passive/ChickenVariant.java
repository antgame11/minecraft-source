...
{
    public static final Codec<ChickenVariant> CODEC = RecordCodecBuilder.create(instance -> instance.group(ModelAndTexture.createMapCodec(Model.CODEC, Model.NORMAL).forGetter(ChickenVariant::modelAndTexture), ((MapCodec)SpawnConditionSelectors.CODEC.fieldOf("spawn_conditions")).forGetter(ChickenVariant::spawnConditions)).apply((Applicative<ChickenVariant, ?>)instance, ChickenVariant::new));
    public static final Codec<ChickenVariant> NETWORK_CODEC = RecordCodecBuilder.create(instance -> instance.group(ModelAndTexture.createMapCodec(Model.CODEC, Model.NORMAL).forGetter(ChickenVariant::modelAndTexture)).apply((Applicative<ChickenVariant, ?>)instance, ChickenVariant::new));
