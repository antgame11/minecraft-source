...
extends HostileEntity {
    ...
    public LivingEntity getBeamTarget() {
        ...
        if (this.getEntityWorld().isClient()) {
            ...
            Entity lv = this.getEntityWorld().getEntityById(this.dataTracker.get(BEAM_TARGET_ID));
        ...
        if (this.isAlive()) {
            if (this.getEntityWorld().isClient()) {
                ...
                if (!this.isTouchingWater()) {
                    ...
                    this.flopping = lv.y < 0.0 && this.getEntityWorld().isTopSolid(this.getBlockPos().down(), this);
                } else {
                ...
                if (this.areSpikesRetracted() && this.isTouchingWater()) {
                    ...
                    for (int i = 0; i < 2; ++i) {
                        this.getEntityWorld().addParticleClient(ParticleTypes.BUBBLE, this.getParticleX(0.5) - lv.x * 1.5, this.getRandomBodyY() - lv.y * 1.5, this.getParticleZ(0.5) - lv.z * 1.5, 0.0, 0.0, 0.0);
                    }
                }
                if (this.hasBeamTarget()) {
                    LivingEntity lv2;
        ...
        public void tick() {
            ...
            if (this.beamTicks == 0) {
                ...
                if (!this.guardian.isSilent()) {
                    this.guardian.getEntityWorld().sendEntityStatus(this.guardian, EntityStatuses.PLAY_GUARDIAN_ATTACK_SOUND);
                }
