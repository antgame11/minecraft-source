...
implements Ownable {
    ...
    private void setVexFlag(int mask, boolean value) {
        ...
        this.dataTracker.set(VEX_FLAGS, (byte)(j & (CHARGING_FLAG | 0xFE)));
    }
    ...
    extends Goal {
        ...
        public void tick() {
            ...
            if (VexEntity.this.getBoundingBox().intersects(lv.getBoundingBox())) {
                VexEntity.this.tryAttack(ChargeTargetGoal.castToServerWorld(VexEntity.this.getEntityWorld()), lv);
                VexEntity.this.setCharging(false);
            } else {
    ...
    extends Goal {
        ...
        public void tick() {
            ...
            for (int i = 0; i < 3; ++i) {
                ...
                if (!VexEntity.this.getEntityWorld().isAir(lv2)) continue;
    ...
    extends TrackTargetGoal {
        ...
        @Override
        public boolean canStart() {
            MobEntity lv = VexEntity.this.getOwner();
            return lv != null && lv.getTarget() != null && this.canTrack(lv.getTarget(), this.targetPredicate);
        }

        @Override
        public void start() {
            MobEntity lv = VexEntity.this.getOwner();
            VexEntity.this.setTarget(lv != null ? lv.getTarget() : null);
            super.start();
        }
    }
}
