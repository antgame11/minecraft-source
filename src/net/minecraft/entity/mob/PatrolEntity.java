...
extends HostileEntity {
    ...
    extends Goal {
        ...
        public void tick() {
            ...
            if (lv.isIdle()) {
                ...
                if (((PatrolEntity)this.entity).isRaidCenterSet() && list.isEmpty()) {
                    ...
                    Vec3d lv3 = ((Entity)this.entity).getEntityPos();
                    ...
                    lv6 = ((Entity)this.entity).getEntityWorld().getTopPosition(Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, lv6);
        ...
        private List<PatrolEntity> findPatrolTargets() {
            return ((Entity)this.entity).getEntityWorld().getEntitiesByClass(PatrolEntity.class, ((Entity)this.entity).getBoundingBox().expand(16.0), arg -> arg.hasNoRaid() && !arg.isPartOf((Entity)this.entity));
        }

        private boolean wander() {
            Random lv = ((Entity)this.entity).getRandom();
            BlockPos lv2 = ((Entity)this.entity).getEntityWorld().getTopPosition(Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, ((Entity)this.entity).getBlockPos().add(-8 + lv.nextInt(16), 0, -8 + lv.nextInt(16)));
