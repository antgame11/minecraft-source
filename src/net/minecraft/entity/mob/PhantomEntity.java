...
implements Monster {
    ...
    extends Goal {
        ...
        public boolean canStart() {
            ...
            if (lv != null) {
                return PhantomEntity.this.testTargetPredicate(StartAttackGoal.castToServerWorld(PhantomEntity.this.getEntityWorld()), lv, TargetPredicate.DEFAULT);
            }
            return false;
        }
    ...
    extends MovementGoal {
        ...
        public void tick() {
            ...
            if (PhantomEntity.this.getBoundingBox().expand(0.2f).intersects(lv.getBoundingBox())) {
                PhantomEntity.this.tryAttack(SwoopMovementGoal.castToServerWorld(PhantomEntity.this.getEntityWorld()), lv);
                PhantomEntity.this.movementType = PhantomMovementType.CIRCLE;
                if (!PhantomEntity.this.isSilent()) {
                    PhantomEntity.this.getEntityWorld().syncWorldEvent(WorldEvents.PHANTOM_BITES, PhantomEntity.this.getBlockPos(), 0);
                }
    ...
    extends Goal {
        ...
        public boolean canStart() {
            ...
            ServerWorld lv = FindTargetGoal.castToServerWorld(PhantomEntity.this.getEntityWorld());
        ...
        public boolean shouldContinue() {
            LivingEntity lv = PhantomEntity.this.getTarget();
            if (lv != null) {
                return PhantomEntity.this.testTargetPredicate(FindTargetGoal.castToServerWorld(PhantomEntity.this.getEntityWorld()), lv, TargetPredicate.DEFAULT);
            }
            return false;
        }
    }
