...
extends SpellcastingIllagerEntity {
    ...
    extends SpellcastingIllagerEntity.CastSpellGoal {
        ...
        protected void castSpell() {
            ServerWorld lv = (ServerWorld)EvokerEntity.this.getEntityWorld();
            ...
            for (int i = 0; i < 3; ++i) {
                ...
                VexEntity lv4 = EntityType.VEX.create(EvokerEntity.this.getEntityWorld(), SpawnReason.MOB_SUMMONED);
                if (lv4 == null) continue;
                lv4.refreshPositionAndAngles(lv3, 0.0f, 0.0f);
                lv4.initialize(lv, EvokerEntity.this.getEntityWorld().getLocalDifficulty(lv3), SpawnReason.MOB_SUMMONED, null);
    ...
    extends SpellcastingIllagerEntity.CastSpellGoal {
        ...
        private void conjureFangs(double x, double z, double maxY, double y, float yaw, int warmup) {
            ...
            do {
                ...
                BlockState lv3 = EvokerEntity.this.getEntityWorld().getBlockState(lv2);
                if (!lv3.isSideSolidFullSquare(EvokerEntity.this.getEntityWorld(), lv2, Direction.UP)) continue;
                if (!EvokerEntity.this.getEntityWorld().isAir(lv) && !(lv5 = (lv4 = EvokerEntity.this.getEntityWorld().getBlockState(lv)).getCollisionShape(EvokerEntity.this.getEntityWorld(), lv)).isEmpty()) {
            ...
            if (bl) {
                EvokerEntity.this.getEntityWorld().spawnEntity(new EvokerFangsEntity(EvokerEntity.this.getEntityWorld(), x, (double)lv.getY() + j, z, yaw, warmup, EvokerEntity.this));
                EvokerEntity.this.getEntityWorld().emitGameEvent(GameEvent.ENTITY_PLACE, new Vec3d(x, (double)lv.getY() + j, z), GameEvent.Emitter.of(EvokerEntity.this));
            }
        }
    ...
    extends SpellcastingIllagerEntity.CastSpellGoal {
        ...
        public boolean canStart() {
            ...
            ServerWorld lv = WololoGoal.castToServerWorld(EvokerEntity.this.getEntityWorld());
