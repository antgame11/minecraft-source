...
public record ContainerLootComponent(RegistryKey<LootTable> lootTable, long seed) implements TooltipAppender
{
    ...
    public static final Codec<ContainerLootComponent> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)LootTable.TABLE_KEY.fieldOf("loot_table")).forGetter(ContainerLootComponent::lootTable), Codec.LONG.optionalFieldOf("seed", 0L).forGetter(ContainerLootComponent::seed)).apply((Applicative<ContainerLootComponent, ?>)instance, ContainerLootComponent::new));
