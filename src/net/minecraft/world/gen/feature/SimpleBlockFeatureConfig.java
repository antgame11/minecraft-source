...
{
    public static final Codec<SimpleBlockFeatureConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)BlockStateProvider.TYPE_CODEC.fieldOf("to_place")).forGetter(config -> config.toPlace), Codec.BOOL.optionalFieldOf("schedule_tick", false).forGetter(arg -> arg.scheduleTick)).apply((Applicative<SimpleBlockFeatureConfig, ?>)instance, SimpleBlockFeatureConfig::new));
