...
extends BlockStateProvider {
    public static final MapCodec<WeightedBlockStateProvider> CODEC = Pool.createNonEmptyCodec(BlockState.CODEC).comapFlatMap(WeightedBlockStateProvider::wrap, arg -> arg.states).fieldOf("entries");
