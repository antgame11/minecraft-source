...
public class BlendingData {
    ...
    private static int getX(int index) {
        ...
        return CHUNK_BIOME_END_INDEX - BlendingData.clampPositive(CHUNK_BIOME_END_INDEX - j);
    }
    ...
    private static int getZ(int index) {
        ...
        int j = index - NORTH_WEST_END_INDEX;
        return CHUNK_BIOME_END_INDEX - BlendingData.clampPositive(j - CHUNK_BIOME_END_INDEX);
    }
