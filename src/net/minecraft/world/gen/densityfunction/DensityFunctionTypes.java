...
public final class DensityFunctionTypes {
    ...
    {
        private static final MapCodec<FindTopSurface> FIND_TOP_SURFACE_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)DensityFunction.FUNCTION_CODEC.fieldOf("density")).forGetter(FindTopSurface::density), ((MapCodec)DensityFunction.FUNCTION_CODEC.fieldOf("upper_bound")).forGetter(FindTopSurface::upperBound), ((MapCodec)Codec.intRange(DimensionType.MIN_HEIGHT * 2, DimensionType.MAX_COLUMN_HEIGHT * 2).fieldOf("lower_bound")).forGetter(FindTopSurface::lowerBound), ((MapCodec)Codecs.POSITIVE_INT.fieldOf("cell_height")).forGetter(FindTopSurface::cellHeight)).apply((Applicative<FindTopSurface, ?>)instance, FindTopSurface::new));
