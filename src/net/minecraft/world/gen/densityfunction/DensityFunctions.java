...
public class DensityFunctions {
    ...
    private static void registerSlopedCheeseFunction(Registerable<DensityFunction> densityFunctionRegisterable, RegistryEntryLookup<DensityFunction> densityFunctionLookup, DensityFunction jaggedNoise, RegistryEntry<DensityFunction> continents, RegistryEntry<DensityFunction> erosion, RegistryKey<DensityFunction> offsetKey, RegistryKey<DensityFunction> factorKey, RegistryKey<DensityFunction> jaggednessKey, RegistryKey<DensityFunction> depthKey, RegistryKey<DensityFunction> slopedCheeseKey, boolean amplified) {
        ...
        DensityFunction lv7 = DensityFunctions.registerAndGetHolder(densityFunctionRegisterable, depthKey, DensityFunctions.applyHeightGradient(lv5));
    ...
    private static DensityFunction estimateUpperBound(DensityFunction density, double bottomDensity, double topDensity, double bottomY, double topY) {
        double h = (topY - bottomY) / (topDensity - bottomDensity);
        double i = bottomY - bottomDensity * h;
        return DensityFunctionTypes.add(DensityFunctionTypes.mul(density, DensityFunctionTypes.constant(h)), DensityFunctionTypes.constant(i));
    }
    ...
    protected static NoiseRouter createSurfaceNoiseRouter(RegistryEntryLookup<DensityFunction> densityFunctionLookup, RegistryEntryLookup<DoublePerlinNoiseSampler.NoiseParameters> noiseParametersLookup, boolean largeBiomes, boolean amplified) {
        ...
        DensityFunction lv9 = DensityFunctions.entryHolder(densityFunctionLookup, largeBiomes ? OFFSET_OVERWORLD_LARGE_BIOME : (amplified ? OFFSET_OVERWORLD_AMPLIFIED : OFFSET_OVERWORLD));
        DensityFunction lv10 = DensityFunctions.entryHolder(densityFunctionLookup, largeBiomes ? FACTOR_OVERWORLD_LARGE_BIOME : (amplified ? FACTOR_OVERWORLD_AMPLIFIED : FACTOR_OVERWORLD));
        DensityFunction lv11 = DensityFunctions.entryHolder(densityFunctionLookup, largeBiomes ? DEPTH_OVERWORLD_LARGE_BIOME : (amplified ? DEPTH_OVERWORLD_AMPLIFIED : DEPTH_OVERWORLD));
        DensityFunction lv12 = DensityFunctions.findTopSurface(lv9, lv10, amplified);
        DensityFunction lv13 = DensityFunctions.entryHolder(densityFunctionLookup, largeBiomes ? SLOPED_CHEESE_OVERWORLD_LARGE_BIOME : (amplified ? SLOPED_CHEESE_OVERWORLD_AMPLIFIED : SLOPED_CHEESE_OVERWORLD));
        DensityFunction lv14 = DensityFunctionTypes.min(lv13, DensityFunctionTypes.mul(DensityFunctionTypes.constant(5.0), DensityFunctions.entryHolder(densityFunctionLookup, CAVES_ENTRANCES_OVERWORLD)));
        DensityFunction lv15 = DensityFunctionTypes.rangeChoice(lv13, -1000000.0, 1.5625, lv14, DensityFunctions.createCavesFunction(densityFunctionLookup, noiseParametersLookup, lv13));
        DensityFunction lv16 = DensityFunctionTypes.min(DensityFunctions.applyBlendDensity(DensityFunctions.applySurfaceSlides(amplified, lv15)), DensityFunctions.entryHolder(densityFunctionLookup, CAVES_NOODLE_OVERWORLD));
        DensityFunction lv17 = DensityFunctions.entryHolder(densityFunctionLookup, Y);
        ...
        DensityFunction lv18 = DensityFunctions.verticalRangeChoice(lv17, DensityFunctionTypes.noise(noiseParametersLookup.getOrThrow(NoiseParametersKeys.ORE_VEININESS), 1.5, 1.5), i, j, 0);
        float f = 4.0f;
        DensityFunction lv19 = DensityFunctions.verticalRangeChoice(lv17, DensityFunctionTypes.noise(noiseParametersLookup.getOrThrow(NoiseParametersKeys.ORE_VEIN_A), 4.0, 4.0), i, j, 0).abs();
        DensityFunction lv20 = DensityFunctions.verticalRangeChoice(lv17, DensityFunctionTypes.noise(noiseParametersLookup.getOrThrow(NoiseParametersKeys.ORE_VEIN_B), 4.0, 4.0), i, j, 0).abs();
        DensityFunction lv21 = DensityFunctionTypes.add(DensityFunctionTypes.constant(-0.08f), DensityFunctionTypes.max(lv19, lv20));
        DensityFunction lv22 = DensityFunctionTypes.noise(noiseParametersLookup.getOrThrow(NoiseParametersKeys.ORE_GAP));
        return new NoiseRouter(lv, lv2, lv3, lv4, lv7, lv8, DensityFunctions.entryHolder(densityFunctionLookup, largeBiomes ? CONTINENTS_OVERWORLD_LARGE_BIOME : CONTINENTS_OVERWORLD), DensityFunctions.entryHolder(densityFunctionLookup, largeBiomes ? EROSION_OVERWORLD_LARGE_BIOME : EROSION_OVERWORLD), lv11, DensityFunctions.entryHolder(densityFunctionLookup, RIDGES_OVERWORLD), lv12, lv16, lv18, lv21, lv22);
    }
    ...
    protected static NoiseRouter createEndNoiseRouter(RegistryEntryLookup<DensityFunction> densityFunctionLookup) {
        ...
        return new NoiseRouter(DensityFunctionTypes.zero(), DensityFunctionTypes.zero(), DensityFunctionTypes.zero(), DensityFunctionTypes.zero(), DensityFunctionTypes.zero(), DensityFunctionTypes.zero(), DensityFunctionTypes.zero(), lv, DensityFunctionTypes.zero(), DensityFunctionTypes.zero(), DensityFunctionTypes.zero(), lv2, DensityFunctionTypes.zero(), DensityFunctionTypes.zero(), DensityFunctionTypes.zero());
    }
    ...
    private static DensityFunction findTopSurface(DensityFunction offset, DensityFunction factor, boolean amplified) {
        DensityFunction lv = DensityFunctionTypes.cache2d(factor);
        DensityFunction lv2 = DensityFunctionTypes.cache2d(offset);
        DensityFunction lv3 = DensityFunctions.estimateUpperBound(DensityFunctionTypes.add(DensityFunctionTypes.mul(DensityFunctionTypes.constant(0.2734375), lv.invert()), DensityFunctionTypes.mul(DensityFunctionTypes.constant(-1.0), lv2)), 1.5, -1.5, -64.0, 320.0);
        lv3 = lv3.clamp(-40.0, 320.0);
        DensityFunction lv4 = DensityFunctionTypes.add(DensityFunctions.applySurfaceSlides(amplified, DensityFunctionTypes.add(DensityFunctions.createInitialDensityFunction(lv, DensityFunctions.applyHeightGradient(lv2)), DensityFunctionTypes.constant(-0.703125)).clamp(-64.0, 64.0)), DensityFunctionTypes.constant(-0.390625));
        return DensityFunctionTypes.findTopSurface(lv4, lv3, -64, GenerationShapeConfig.SURFACE.verticalCellBlockCount());
    }
