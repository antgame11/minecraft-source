...
extends AbstractCountPlacementModifier {
    public static final MapCodec<NoiseBasedCountPlacementModifier> MODIFIER_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)Codec.INT.fieldOf("noise_to_count_ratio")).forGetter(placementModifier -> placementModifier.noiseToCountRatio), ((MapCodec)Codec.DOUBLE.fieldOf("noise_factor")).forGetter(placementModifier -> placementModifier.noiseFactor), ((MapCodec)Codec.DOUBLE.fieldOf("noise_offset")).orElse(0.0).forGetter(placementModifier -> placementModifier.noiseOffset)).apply((Applicative<NoiseBasedCountPlacementModifier, ?>)instance, NoiseBasedCountPlacementModifier::new));
