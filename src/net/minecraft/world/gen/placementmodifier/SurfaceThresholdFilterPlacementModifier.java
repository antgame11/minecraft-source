...
extends AbstractConditionalPlacementModifier {
    public static final MapCodec<SurfaceThresholdFilterPlacementModifier> MODIFIER_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)Heightmap.Type.CODEC.fieldOf("heightmap")).forGetter(placementModifier -> placementModifier.heightmap), Codec.INT.optionalFieldOf("min_inclusive", Integer.MIN_VALUE).forGetter(placementModifier -> placementModifier.min), Codec.INT.optionalFieldOf("max_inclusive", Integer.MAX_VALUE).forGetter(placementModifier -> placementModifier.max)).apply((Applicative<SurfaceThresholdFilterPlacementModifier, ?>)instance, SurfaceThresholdFilterPlacementModifier::new));
