...
extends AbstractCountPlacementModifier {
    public static final MapCodec<NoiseThresholdCountPlacementModifier> MODIFIER_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)Codec.DOUBLE.fieldOf("noise_level")).forGetter(placementModifier -> placementModifier.noiseLevel), ((MapCodec)Codec.INT.fieldOf("below_noise")).forGetter(placementModifier -> placementModifier.belowNoise), ((MapCodec)Codec.INT.fieldOf("above_noise")).forGetter(placementModifier -> placementModifier.aboveNoise)).apply((Applicative<NoiseThresholdCountPlacementModifier, ?>)instance, NoiseThresholdCountPlacementModifier::new));
