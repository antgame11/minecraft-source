...
extends AbstractConditionalPlacementModifier {
    public static final MapCodec<BlockFilterPlacementModifier> MODIFIER_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)BlockPredicate.BASE_CODEC.fieldOf("predicate")).forGetter(placementModifier -> placementModifier.predicate)).apply((Applicative<BlockFilterPlacementModifier, ?>)instance, BlockFilterPlacementModifier::new));
