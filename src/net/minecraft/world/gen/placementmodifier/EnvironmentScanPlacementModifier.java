...
extends PlacementModifier {
    ...
    public static final MapCodec<EnvironmentScanPlacementModifier> MODIFIER_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)Direction.VERTICAL_CODEC.fieldOf("direction_of_search")).forGetter(placementModifier -> placementModifier.direction), ((MapCodec)BlockPredicate.BASE_CODEC.fieldOf("target_condition")).forGetter(placementModifier -> placementModifier.targetPredicate), BlockPredicate.BASE_CODEC.optionalFieldOf("allowed_search_condition", BlockPredicate.alwaysTrue()).forGetter(placementModifier -> placementModifier.allowedSearchPredicate), ((MapCodec)Codec.intRange(1, 32).fieldOf("max_steps")).forGetter(placementModifier -> placementModifier.maxSteps)).apply((Applicative<EnvironmentScanPlacementModifier, ?>)instance, EnvironmentScanPlacementModifier::new));
