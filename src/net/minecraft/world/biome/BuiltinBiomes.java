...
public abstract class BuiltinBiomes {
    public static void bootstrap(Registerable<Biome> biomeRegisterable) {
        ...
        biomeRegisterable.register(BiomeKeys.DARK_FOREST, OverworldBiomeCreator.createDenseForest(lv, lv2, false));
        biomeRegisterable.register(BiomeKeys.PALE_GARDEN, OverworldBiomeCreator.createDenseForest(lv, lv2, true));
