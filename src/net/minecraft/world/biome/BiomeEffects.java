...
public class BiomeEffects {
    public static final Codec<BiomeEffects> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)Codec.INT.fieldOf("fog_color")).forGetter(effects -> effects.fogColor), ((MapCodec)Codec.INT.fieldOf("water_color")).forGetter(effects -> effects.waterColor), ((MapCodec)Codec.INT.fieldOf("water_fog_color")).forGetter(effects -> effects.waterFogColor), ((MapCodec)Codec.INT.fieldOf("sky_color")).forGetter(effects -> effects.skyColor), Codec.INT.optionalFieldOf("foliage_color").forGetter(effects -> effects.foliageColor), Codec.INT.optionalFieldOf("dry_foliage_color").forGetter(effects -> effects.dryFoliageColor), Codec.INT.optionalFieldOf("grass_color").forGetter(effects -> effects.grassColor), GrassColorModifier.CODEC.optionalFieldOf("grass_color_modifier", GrassColorModifier.NONE).forGetter(effects -> effects.grassColorModifier), BiomeParticleConfig.CODEC.optionalFieldOf("particle").forGetter(effects -> effects.particleConfig), SoundEvent.ENTRY_CODEC.optionalFieldOf("ambient_sound").forGetter(effects -> effects.loopSound), BiomeMoodSound.CODEC.optionalFieldOf("mood_sound").forGetter(effects -> effects.moodSound), BiomeAdditionsSound.CODEC.optionalFieldOf("additions_sound").forGetter(effects -> effects.additionsSound), Pool.createCodec(MusicSound.CODEC).optionalFieldOf("music").forGetter(effects -> effects.music), ((MapCodec)Codec.FLOAT.fieldOf("music_volume")).orElse(Float.valueOf(1.0f)).forGetter(effects -> Float.valueOf(effects.musicVolume))).apply((Applicative<BiomeEffects, ?>)instance, BiomeEffects::new));
