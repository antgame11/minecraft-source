...
public class TheNetherBiomeCreator {
    ...
    public static Biome createBasaltDeltas(RegistryEntryLookup<PlacedFeature> featureLookup, RegistryEntryLookup<ConfiguredCarver<?>> carverLookup) {
        SpawnSettings lv = new SpawnSettings.Builder().spawn(SpawnGroup.MONSTER, 40, new SpawnSettings.SpawnEntry(EntityType.GHAST, 1, 1)).spawn(SpawnGroup.MONSTER, 100, new SpawnSettings.SpawnEntry(EntityType.MAGMA_CUBE, 2, 5)).spawn(SpawnGroup.CREATURE, 60, new SpawnSettings.SpawnEntry(EntityType.STRIDER, 1, 2)).build();
    ...
    public static Biome createWarpedForest(RegistryEntryLookup<PlacedFeature> featureLookup, RegistryEntryLookup<ConfiguredCarver<?>> carverLookup) {
        SpawnSettings lv = new SpawnSettings.Builder().spawn(SpawnGroup.MONSTER, 1, new SpawnSettings.SpawnEntry(EntityType.ENDERMAN, 4, 4)).spawn(SpawnGroup.CREATURE, 60, new SpawnSettings.SpawnEntry(EntityType.STRIDER, 1, 2)).spawnCost(EntityType.ENDERMAN, 1.0, 0.12).build();
        GenerationSettings.LookupBackedBuilder lv2 = new GenerationSettings.LookupBackedBuilder(featureLookup, carverLookup).carver(ConfiguredCarvers.NETHER_CAVE).feature(GenerationStep.Feature.VEGETAL_DECORATION, MiscPlacedFeatures.SPRING_LAVA);
        DefaultBiomeFeatures.addDefaultMushrooms(lv2);
