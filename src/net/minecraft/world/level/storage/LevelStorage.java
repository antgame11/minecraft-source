...
public class LevelStorage {
    ...
    static Dynamic<?> readLevelProperties(Path path, DataFixer dataFixer) throws IOException {
        ...
        NbtCompound lv2 = lv.getCompoundOrEmpty(DATA_KEY);
        ...
        if (Files.exists(path, new LinkOption[0])) {
            try {
                ...
                if (lv instanceof NbtCompound) {
                    ...
                    NbtCompound lv3 = lv2.getCompoundOrEmpty(DATA_KEY);
                    int i = NbtHelper.getDataVersion(lv3, -1);
                    Dynamic<NbtCompound> dynamic = DataFixTypes.LEVEL_SUMMARY.update(this.dataFixer, new Dynamic<NbtCompound>(NbtOps.INSTANCE, lv3), i);
    ...
    implements AutoCloseable {
        ...
        private void save(Consumer<NbtCompound> nbtProcessor) throws IOException {
            ...
            nbtProcessor.accept(lv.getCompoundOrEmpty(LevelStorage.DATA_KEY));
            this.save(lv);
        }
