...
StructureHolder {
    ...
    public Chunk(ChunkPos pos, UpgradeData upgradeData, HeightLimitView heightLimitView, PalettesFactory palettesFactory, long inhabitedTime, @Nullable ChunkSection[] sectionArray, @Nullable BlendingData blendingData) {
        this.pos = pos;
    ...
    public void addPendingBlockEntityNbt(NbtCompound nbt) {
        BlockPos lv = BlockEntity.posFromNbt(this.pos, nbt);
