...
public class PlayStateFactories {
    public static final PacketCodecModifier<RegistryByteBuf, CreativeInventoryActionC2SPacket, PacketCodecModifierContext> CREATIVE_INVENTORY_ACTION_C2S_MODIFIER = (packetCodec, context) -> new PacketCodec<RegistryByteBuf, CreativeInventoryActionC2SPacket>(){
        ...
        @Override
        public CreativeInventoryActionC2SPacket decode(RegistryByteBuf arg) {
            if (!context.isInCreativeMode()) {
                throw new PacketDecoderException("Not in creative mode");
            }
            return (CreativeInventoryActionC2SPacket)packetCodec.decode(arg);
        }

        @Override
        public void encode(RegistryByteBuf arg, CreativeInventoryActionC2SPacket arg2) {
            if (!context.isInCreativeMode()) {
                throw new PacketEncoderException("Not in creative mode");
            }
            packetCodec.encode(arg, arg2);
        }
