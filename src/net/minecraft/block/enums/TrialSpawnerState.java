...
public enum TrialSpawnerState implements StringIdentifiable
{
        ...
        return switch (this.ordinal()) {
                ...
                if (lv.hasSpawnedAllMobs(lv2, i)) {
                    ...
                    logic.trySpawnMob(world, pos).ifPresent(uuid -> {
                        ...
                        lv2.spawnPotentials().getOrEmpty(world.getRandom()).ifPresent(spawnData -> {
                            arg.spawnData = Optional.of(spawnData);
            ...
            case 4 -> {
                ...
                if (lv.rewardLootTable.isEmpty()) {
                    lv.rewardLootTable = lv2.lootTablesToEject().getOrEmpty(world.getRandom());
                }
    ...
    private void spawnOminousItemSpawner(ServerWorld world, BlockPos pos2, TrialSpawnerLogic logic) {
        ...
        TrialSpawnerData lv = logic.getData();
        ItemStack lv3 = lv.getItemsToDropWhenOminous(world, lv2 = logic.getConfig(), pos2).getOrEmpty(world.random).orElse(ItemStack.EMPTY);
        if (lv3.isEmpty()) {
            return;
        }
