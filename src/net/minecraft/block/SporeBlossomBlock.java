...
extends Block {
    ...
    public void randomDisplayTick(BlockState state, World world, BlockPos pos, Random random) {
        ...
        for (int l = 0; l < 14; ++l) {
            ...
            world.addParticleClient(ParticleTypes.SPORE_BLOSSOM_AIR, (double)lv.getX() + random.nextDouble(), (double)lv.getY() + random.nextDouble(), (double)lv.getZ() + random.nextDouble(), 0.0, 0.0, 0.0);
        }
    }
