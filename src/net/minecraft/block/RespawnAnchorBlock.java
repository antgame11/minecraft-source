    ...
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        if (RespawnAnchorBlock.isNether(world)) {
            if (player instanceof ServerPlayerEntity) {
                ...
                ServerPlayerEntity.Respawn lv2 = lv.getRespawn();
                ServerPlayerEntity.Respawn lv3 = new ServerPlayerEntity.Respawn(WorldProperties.SpawnPoint.create(world.getRegistryKey(), pos, 0.0f, 0.0f), false);
                if (lv2 == null || !lv2.posEquals(lv3)) {
                    lv.setSpawnPoint(lv3, true);
