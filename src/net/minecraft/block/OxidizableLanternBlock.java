...
implements Oxidizable {
    public static final MapCodec<OxidizableLanternBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)Oxidizable.OxidationLevel.CODEC.fieldOf("weathering_state")).forGetter(OxidizableLanternBlock::getDegradationLevel), OxidizableLanternBlock.createSettingsCodec()).apply((Applicative<OxidizableLanternBlock, ?>)instance, OxidizableLanternBlock::new));
