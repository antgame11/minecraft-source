...
implements Fertilizable {
    ...
    public FireflyBushBlock(AbstractBlock.Settings arg) {
        super(arg);
    }
    ...
    public void grow(ServerWorld world, Random random, BlockPos pos, BlockState state) {
        Fertilizable.findPosToSpreadTo(world, pos, state).ifPresent(arg2 -> world.setBlockState((BlockPos)arg2, this.getDefaultState()));
    }
}
