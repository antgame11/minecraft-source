...
implements Oxidizable {
    public static final MapCodec<OxidizableLightningRodBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)Oxidizable.OxidationLevel.CODEC.fieldOf("weathering_state")).forGetter(OxidizableLightningRodBlock::getDegradationLevel), OxidizableLightningRodBlock.createSettingsCodec()).apply((Applicative<OxidizableLightningRodBlock, ?>)instance, OxidizableLightningRodBlock::new));
