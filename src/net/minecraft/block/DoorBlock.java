...
extends Block {
    ...
    protected VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        ...
        Direction lv2 = state.get(OPEN).booleanValue() ? (state.get(HINGE) == DoorHinge.RIGHT ? lv.rotateYCounterclockwise() : lv.rotateYClockwise()) : lv;
        return SHAPES_BY_DIRECTION.get(lv2);
    }
