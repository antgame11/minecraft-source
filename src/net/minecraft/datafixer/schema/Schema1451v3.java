...
extends IdentifierNormalizingSchema {
    ...
    public Map<String, Supplier<TypeTemplate>> registerEntities(Schema schema) {
        ...
        schema.register(map, "minecraft:commandblock_minecart", () -> DSL.optionalFields("DisplayState", TypeReferences.BLOCK_STATE.in(schema), "LastOutput", TypeReferences.TEXT_COMPONENT.in(schema)));
