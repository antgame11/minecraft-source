...
extends Schema {
    ...
    public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema schema) {
        ...
        BlockEntityIdFix.RENAMED_BLOCK_ENTITIES.forEach((string, string2) -> map.put((String)string2, Objects.requireNonNull((Supplier)map.remove(string), () -> "Didn't find " + string + " in schema")));
        return map;
    }
    ...
    public void registerTypes(Schema schema, Map<String, Supplier<TypeTemplate>> entityTypes, Map<String, Supplier<TypeTemplate>> blockEntityTypes) {
        ...
        schema.registerType(true, TypeReferences.ITEM_STACK, () -> DSL.hook(DSL.optionalFields("id", TypeReferences.ITEM_NAME.in(schema), "tag", Schema99.method_66195(schema)), field_5745, Hook.HookFunction.IDENTITY));
    }
}
