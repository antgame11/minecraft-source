...
public class Schemas {
    ...
    private static void build(DataFixerBuilder builder) {
        ...
        builder.addFixer(new GameEventRenamesFix(schema124, "Nether biome rename", TypeReferences.BIOME, Schemas.replacing("minecraft:nether", "minecraft:nether_wastes")));
        Schema schema125 = builder.addSchema(2553, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(new GameEventRenamesFix(schema125, "Biomes fix", TypeReferences.BIOME, Schemas.replacing(FlatteningBiomeMapping.RENAMED_BIOMES)));
        ...
        builder.addFixer(ItemNameFix.create(schema134, "Renamed copper block items to new oxidized terms", Schemas.replacing(immutableMap)));
        builder.addFixer(BlockNameFix.create(schema134, "Renamed copper blocks to new oxidized terms", Schemas.replacing(immutableMap)));
        ...
        builder.addFixer(ItemNameFix.create(schema135, "Rename copper item suffixes", Schemas.replacing(immutableMap2)));
        builder.addFixer(BlockNameFix.create(schema135, "Rename copper blocks suffixes", Schemas.replacing(immutableMap2)));
        ...
        builder.addFixer(ItemNameFix.create(schema137, "Renamed grimstone block items to deepslate", Schemas.replacing(immutableMap3)));
        builder.addFixer(BlockNameFix.create(schema137, "Renamed grimstone blocks to deepslate", Schemas.replacing(immutableMap3)));
        Schema schema138 = builder.addSchema(2700, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(BlockNameFix.create(schema138, "Renamed cave vines blocks", Schemas.replacing(ImmutableMap.of("minecraft:cave_vines_head", "minecraft:cave_vines", "minecraft:cave_vines_body", "minecraft:cave_vines_plant"))));
        ...
        builder.addFixer(ItemNameFix.create(schema144, "Rename azalea_leaves_flowers", Schemas.replacing(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))));
        builder.addFixer(BlockNameFix.create(schema144, "Rename azalea_leaves_flowers items", Schemas.replacing(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))));
        ...
        builder.addFixer(new GameEventRenamesFix(schema149, "Caves and Cliffs biome renames", TypeReferences.BIOME, Schemas.replacing(LegacyBiomeMapping.MAP)));
        ...
        builder.addFixer(new GameEventRenamesFix(schema152, "Remove Deep Warm Ocean", TypeReferences.BIOME, Schemas.replacing("minecraft:deep_warm_ocean", "minecraft:warm_ocean")));
        Schema schema153 = builder.addSchema(2846, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(new AdvancementRenameFix(schema153, false, "Rename some C&C part 2 advancements", Schemas.replacing(ImmutableMap.of("minecraft:husbandry/play_jukebox_in_meadows", "minecraft:adventure/play_jukebox_in_meadows", "minecraft:adventure/caves_and_cliff", "minecraft:adventure/fall_from_world_height", "minecraft:adventure/ride_strider_in_overworld_lava", "minecraft:nether/ride_strider_in_overworld_lava"))));
        ...
        builder.addFixer(new AdvancementCriteriaRenameFix(schema164, "Migrate cat variant advancement", "minecraft:husbandry/complete_catalogue", string -> immutableMap4.getOrDefault(string, (String)string)));
        Schema schema165 = builder.addSchema(3087, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(new EntityVariantTypeFix(schema165, "Change frog variant type", TypeReferences.ENTITY, "minecraft:frog", "Variant", Util.make(new Int2ObjectOpenHashMap(), frogVariants -> {
        ...
        builder.addFixer(new GameEventRenamesFix(schema186, "Replace experimental 1.20 overworld", TypeReferences.MULTI_NOISE_BIOME_SOURCE_PARAMETER_LIST, Schemas.replacing("minecraft:overworld_update_1_20", "minecraft:overworld")));
        ...
        builder.addFixer(new RenameChunkStatusFix(schema189, "Remove liquid_carvers and heightmap chunk statuses", Schemas.replacing(Map.of("minecraft:liquid_carvers", "minecraft:carvers", "minecraft:heightmaps", "minecraft:spawn"))));
        ...
        builder.addFixer(new RenameEntityAttributesFix(schema213, "Rename jump strength attribute", Schemas.replacing("minecraft:horse.jump_strength", "minecraft:generic.jump_strength")));
        ...
        builder.addFixer(new EntityAttributeBaseFix(schema246, "Villager follow range fix undo", "minecraft:villager", "minecraft:follow_range", followRange -> followRange == 48.0 ? 16.0 : followRange));
        builder.addFixer(new EntityAttributeBaseFix(schema246, "Bee follow range fix", "minecraft:bee", "minecraft:follow_range", followRange -> followRange == 48.0 ? 16.0 : followRange));
        builder.addFixer(new EntityAttributeBaseFix(schema246, "Allay follow range fix", "minecraft:allay", "minecraft:follow_range", followRange -> followRange == 48.0 ? 16.0 : followRange));
        builder.addFixer(new EntityAttributeBaseFix(schema246, "Llama follow range fix", "minecraft:llama", "minecraft:follow_range", followRange -> followRange == 40.0 ? 16.0 : followRange));
        builder.addFixer(new EntityAttributeBaseFix(schema246, "Piglin Brute follow range fix", "minecraft:piglin_brute", "minecraft:follow_range", followRange -> followRange == 16.0 ? 12.0 : followRange));
        builder.addFixer(new EntityAttributeBaseFix(schema246, "Warden follow range fix", "minecraft:warden", "minecraft:follow_range", followRange -> followRange == 16.0 ? 24.0 : followRange));
        Schema schema247 = builder.addSchema(4290, Schema4290::new);
        builder.addFixer(new UnflattenTextComponentFix(schema247));
        Schema schema279 = builder.addSchema(4291, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(new LegacyHoverEventFix((Schema)schema248));
        builder.addFixer(new TextComponentStringyFlagsFix((Schema)schema248));
        Schema schema280 = builder.addSchema(4292, Schema4292::new);
        builder.addFixer(new TextComponentHoverAndClickEventFix((Schema)schema249));
        Schema schema281 = builder.addSchema(4293, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(new DropChancesFormatFix((Schema)schema250));
        Schema schema282 = builder.addSchema(4294, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(new SimpleBlockPropertyRenameFix((Schema)schema251, "CreakingHeartBlockStateFix", "minecraft:creaking_heart", "active", "creaking_heart_state", value -> value.equals("true") ? "awake" : "uprooted"));
        Schema schema283 = builder.addSchema(4295, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(new BlendingDataFix((Schema)schema252));
        Schema schema284 = builder.addSchema(4296, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(new AreaEffectCloudDurationScaleFix((Schema)schema253));
        Schema schema285 = builder.addSchema(4297, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(new ForcedChunkToTicketFix((Schema)schema254));
        Schema schema286 = builder.addSchema(4299, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(new ItemVariantComponentizationFix((Schema)schema255));
        Schema schema287 = builder.addSchema(4300, Schema4300::new);
        builder.addFixer(new SaddleEquipmentSlotFix((Schema)schema256));
        Schema schema288 = builder.addSchema(4301, Schema4301::new);
        builder.addFixer(new EquipmentFormatFix((Schema)schema257));
        Schema schema289 = builder.addSchema(4302, Schema4302::new);
        builder.addFixer(new ChoiceTypesFix((Schema)schema258, "Added Test and Test Instance Block Entities", TypeReferences.BLOCK_ENTITY));
        Schema schema290 = builder.addSchema(4303, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(new EntityFallDistanceFloatToDoubleFix((Schema)schema259, TypeReferences.ENTITY));
        builder.addFixer(new EntityFallDistanceFloatToDoubleFix((Schema)schema259, TypeReferences.PLAYER));
        Schema schema291 = builder.addSchema(4305, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(new SimpleBlockPropertyRenameFix((Schema)schema260, "rename test block mode", "minecraft:test_block", "test_block_mode", "mode", value -> value));
        Schema schema292 = builder.addSchema(4306, Schema4306::new);
        builder.addFixer(new ThrownPotionSplitFix((Schema)schema261));
        Schema schema293 = builder.addSchema(4307, Schema4307::new);
        builder.addFixer(new TooltipDisplayComponentFix((Schema)schema262));
        Schema schema294 = builder.addSchema(4309, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(new RaidRenamesDataFix((Schema)schema263));
        builder.addFixer(new ChunkTicketUnpackPosFix((Schema)schema263));
        Schema schema295 = builder.addSchema(4311, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(new AdvancementRenameFix((Schema)schema264, false, "Use lodestone category change", Schemas.replacing("minecraft:nether/use_lodestone", "minecraft:adventure/use_lodestone")));
        Schema schema296 = builder.addSchema(4312, Schema4312::new);
        builder.addFixer(new PlayerEquipmentFix((Schema)schema265));
        Schema schema297 = builder.addSchema(4314, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(new InlineBlockPosFormatFix((Schema)schema266));
        Schema schema298 = builder.addSchema(4420, Schema4420::new);
        builder.addFixer(new TypeChangeFix((Schema)schema267, "AreaEffectCloudCustomParticleFix", TypeReferences.ENTITY, "minecraft:area_effect_cloud"));
        Schema schema299 = builder.addSchema(4421, Schema4421::new);
        builder.addFixer(new ChoiceTypesFix((Schema)schema268, "Added Happy Ghast", TypeReferences.ENTITY));
        Schema schema300 = builder.addSchema(4424, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(new RemoveFeatureTogglesFix((Schema)schema269, "Remove Locator Bar experimental feature flag", Set.of("minecraft:locator_bar")));
        builder.addFixer(new AddFieldFix((Schema)schema269, TypeReferences.PLAYER, "style", dynamic -> dynamic.createString("minecraft:default"), "locator_bar_icon"));
        builder.addFixer(new AddFieldFix((Schema)schema269, TypeReferences.ENTITY, "style", dynamic -> dynamic.createString("minecraft:default"), "locator_bar_icon"));
        Schema schema301 = builder.addSchema(4531, Schema4531::new);
        builder.addFixer(new ChoiceTypesFix((Schema)schema270, "Added Copper Golem", TypeReferences.ENTITY));
        Schema schema302 = builder.addSchema(4532, Schema4532::new);
        builder.addFixer(new ChoiceTypesFix((Schema)schema271, "Added Copper Golem Statue Block Entity", TypeReferences.BLOCK_ENTITY));
        Schema schema303 = builder.addSchema(4533, Schema4533::new);
        builder.addFixer(new ChoiceTypesFix((Schema)schema272, "Added Shelf", TypeReferences.BLOCK_ENTITY));
        Schema schema304 = builder.addSchema(4535, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(new CopperGolemWeatherStateFix((Schema)schema273));
        Schema schema305 = builder.addSchema(4537, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(new ChunkDeleteLightFix((Schema)schema274));
        Schema schema306 = builder.addSchema(4541, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(BlockNameFix.create((Schema)schema275, "Rename chain to iron_chain", Schemas.replacing("minecraft:chain", "minecraft:iron_chain")));
        builder.addFixer(ItemNameFix.create((Schema)schema275, "Rename chain to iron_chain", Schemas.replacing("minecraft:chain", "minecraft:iron_chain")));
        Schema schema307 = builder.addSchema(4543, Schema4543::new);
        builder.addFixer(new ChoiceTypesFix((Schema)schema276, "Added Mannequin", TypeReferences.ENTITY));
        Schema schema308 = builder.addSchema(4544, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(new LegacyWorldBorderFix((Schema)schema277));
        Schema schema309 = builder.addSchema(4548, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(new WorldSpawnDataFix((Schema)schema278));
        builder.addFixer(new PlayerRespawnDataFix((Schema)schema278));
    }
