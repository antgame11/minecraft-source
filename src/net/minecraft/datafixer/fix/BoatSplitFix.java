...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("BoatSplitFix", type, type2, (Typed<?> typed) -> {
            ...
            if (optional.isPresent() && BoatSplitFix.isBoatOrChestBoat((String)optional.get())) {
                ...
                return FixUtil.withType(type2, typed).update(DSL.remainderFinder(), dynamic -> dynamic.remove("Type")).set(opticFinder, string);
            }
