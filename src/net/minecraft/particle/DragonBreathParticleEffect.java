...
implements ParticleEffect {
    ...
    public static MapCodec<DragonBreathParticleEffect> createCodec(ParticleType<DragonBreathParticleEffect> type) {
        return Codec.FLOAT.xmap(power -> new DragonBreathParticleEffect(type, power.floatValue()), effect -> Float.valueOf(effect.power)).optionalFieldOf("power", DragonBreathParticleEffect.of(type, 1.0f));
    }
