...
public record SpawnParticlesEnchantmentEffect(ParticleEffect particle, PositionSource horizontalPosition, PositionSource verticalPosition, VelocitySource horizontalVelocity, VelocitySource verticalVelocity, FloatProvider speed) implements EnchantmentEntityEffect
{
    ...
    public void apply(ServerWorld world, int level, EnchantmentEffectContext context, Entity user, Vec3d pos) {
        ...
        world.spawnParticles(this.particle, this.horizontalPosition.getPosition(pos.getX(), pos.getX(), f, lv), this.verticalPosition.getPosition(pos.getY(), pos.getY() + (double)(g / 2.0f), g, lv), this.horizontalPosition.getPosition(pos.getZ(), pos.getZ(), f, lv), 0, this.horizontalVelocity.getVelocity(lv2.getX(), lv), this.verticalVelocity.getVelocity(lv2.getY(), lv), this.horizontalVelocity.getVelocity(lv2.getZ(), lv), this.speed.get(lv));
    }
