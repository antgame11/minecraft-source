...
implements DataCommandObject {
    ...
    public void setNbt(NbtCompound nbt) throws CommandSyntaxException {
        ...
        try (ErrorReporter.Logging lv = new ErrorReporter.Logging(this.entity.getErrorReporterContext(), LOGGER);){
            this.entity.readData(NbtReadView.create(lv, this.entity.getRegistryManager(), nbt));
