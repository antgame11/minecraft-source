...
public class EntitySelectorReader {
    ...
    private Double dz;
    @Nullable
    private NumberRange.AngleRange pitchRange;
    @Nullable
    private NumberRange.AngleRange yawRange;
    ...
    public static <S> boolean shouldAllowAtSelectors(S source) {
        PermissionLevelSource lv;
        return source instanceof PermissionLevelSource && (lv = (PermissionLevelSource)source).hasElevatedPermissions();
    }
    ...
    private void buildPredicate() {
        ...
        if (this.levelRange != null) {
            this.predicates.add(entity -> {
                ...
                if (!this.levelRange.test(lv.experienceLevel)) return false;
                return true;
            });
        }
    }
    ...
    @Nullable
    public NumberRange.AngleRange getPitchRange() {
    ...
    @Nullable
    public NumberRange.AngleRange getYawRange() {
