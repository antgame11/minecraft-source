...
public class SlotRanges {
    ...
    private static final Function<String, SlotRange> FROM_NAME = StringIdentifiable.createMapper((StringIdentifiable[])((SlotRange[])SLOT_RANGES.toArray(SlotRange[]::new)));
