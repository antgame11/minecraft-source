...
public interface ArmorMaterials {
    ...
    public static final ArmorMaterial NETHERITE = new ArmorMaterial(37, ArmorMaterials.createDefenseMap(3, 6, 8, 3, 11), 15, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 3.0f, 0.1f, ItemTags.REPAIRS_NETHERITE_ARMOR, EquipmentAssetKeys.NETHERITE);
