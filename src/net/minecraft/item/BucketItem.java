...
implements FluidModificationItem {
    ...
    public ActionResult use(World world, PlayerEntity user, Hand hand) {
        ...
        if (lv2.getType() == HitResult.Type.BLOCK) {
            ...
            if (!world.canEntityModifyAt(user, lv3) || !user.canPlaceOn(lv5, lv4, lv)) {
    ...
    public boolean placeFluid(@Nullable LivingEntity user, World world, BlockPos pos, @Nullable BlockHitResult hitResult) {
        ...
        boolean bl3 = bl || lv3 instanceof FluidFillable && (lv4 = (FluidFillable)((Object)lv3)).canFillWithFluid(user, world, pos, lv2, this.fluid);
        boolean bl5 = bl4 = lv2.isAir() || bl3 && (!bl2 || hitResult == null);
        if (!bl4) {
        ...
        if (lv3 instanceof FluidFillable) {
            FluidFillable lv5 = (FluidFillable)((Object)lv3);
            if (this.fluid == Fluids.WATER) {
                lv5.tryFillWithFluid(world, pos, lv2, lv.getStill(false));
    ...
    protected void playEmptyingSound(@Nullable LivingEntity user, WorldAccess world, BlockPos pos) {
        ...
        world.playSound(user, pos, lv, SoundCategory.BLOCKS, 1.0f, 1.0f);
