...
public class TradeOffers {
    ...
    record TypedWrapperFactory(Map<RegistryKey<VillagerType>, Factory> typeToFactory) implements Factory
    {
        ...
        public static TypedWrapperFactory of(Factory factory, RegistryKey<VillagerType> ... types) {
            return new TypedWrapperFactory(Arrays.stream(types).collect(Collectors.toMap(arg -> arg, arg2 -> factory)));
        }
        ...
        public TradeOffer create(Entity entity, Random random) {
            if (entity instanceof VillagerDataContainer) {
                ...
                RegistryKey lv2 = lv.getVillagerData().type().getKey().orElse(null);
                if (lv2 == null) {
                    return null;
                }
    ...
    implements Factory {
        ...
        public TradeOffer create(Entity entity, Random random) {
            ...
            DynamicRegistryManager lv = entity.getEntityWorld().getRegistryManager();
    ...
    implements Factory {
        ...
        public TradeOffer create(Entity entity, Random random) {
            if (entity instanceof VillagerDataContainer) {
                ...
                TradedItem lv3 = new TradedItem(this.map.get(lv2), this.count);
                return new TradeOffer(lv3, new ItemStack(Items.EMERALD), this.maxUses, this.experience, 0.05f);
            }
            return null;
        }
    }
    ...
    implements Factory {
        ...
        public TradeOffer create(Entity entity, Random random) {
            ...
            List list = Registries.POTION.streamEntries().filter(entry -> !((Potion)entry.value()).getEffects().isEmpty() && entity.getEntityWorld().getBrewingRecipeRegistry().isBrewable((RegistryEntry<Potion>)entry)).collect(Collectors.toList());
