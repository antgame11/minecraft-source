...
extends AbstractCriterion<Conditions> {
    ...
    {
        public static final Codec<Conditions> CODEC = RecordCodecBuilder.create((RecordCodecBuilder.Instance<O> instance) -> instance.group(EntityPredicate.LOOT_CONTEXT_PREDICATE_CODEC.optionalFieldOf("player").forGetter(Conditions::player), ((MapCodec)LootTable.TABLE_KEY.fieldOf("loot_table")).forGetter(Conditions::lootTable)).apply((Applicative<Conditions, ?>)instance, Conditions::new));
