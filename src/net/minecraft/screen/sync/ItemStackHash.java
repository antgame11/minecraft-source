...
public interface ItemStackHash {
    ...
    public static final PacketCodec<RegistryByteBuf, ItemStackHash> PACKET_CODEC = PacketCodecs.optional(Impl.PACKET_CODEC).xmap(hash -> DataFixUtils.orElse(hash, EMPTY), hash -> {
