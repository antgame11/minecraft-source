...
extends ScreenHandler {
    ...
    private List<RegistryEntry<BannerPattern>> getPatternsFor(ItemStack stack) {
        ...
        TagKey<BannerPattern> lv = stack.get(DataComponentTypes.PROVIDES_BANNER_PATTERNS);
        if (lv != null) {
            return this.bannerPatternLookup.getOptional(lv).map(ImmutableList::copyOf).orElse(ImmutableList.of());
        }
        return List.of();
    }
