            ...
            public void onResponse(QueryResponseS2CPacket packet) {
                ...
                lv3.players().ifPresentOrElse(players -> {
                    ...
                    if (!players.sample().isEmpty()) {
                        ...
                        for (PlayerConfigEntry lv3 : players.sample()) {
                            MutableText lv22 = lv3.equals(MinecraftServer.ANONYMOUS_PLAYER_PROFILE) ? Text.translatable("multiplayer.status.anonymous_player") : Text.literal(lv3.name());
                            list.add(lv22);
                        }
