...
extends RealmsScreen {
    ...
    extends AlwaysSelectedEntryListWidget.Entry<BackupInfoListEntry> {
        ...
        public void render(DrawContext context, int mouseX, int mouseY, boolean hovered, float deltaTicks) {
            context.drawTextWithShadow(RealmsBackupInfoScreen.this.textRenderer, this.getTextFromKey(this.key), this.getContentX(), this.getContentY(), Colors.LIGHT_GRAY);
            context.drawTextWithShadow(RealmsBackupInfoScreen.this.textRenderer, RealmsBackupInfoScreen.this.checkForSpecificMetadata(this.key, this.value), this.getContentX(), this.getContentY() + 12, Colors.WHITE);
        }
