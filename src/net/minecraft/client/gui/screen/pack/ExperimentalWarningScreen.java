    ...
    extends Screen {
        ...
        extends AlwaysSelectedEntryListWidget.Entry<PackListWidgetEntry> {
            ...
            public void render(DrawContext context, int mouseX, int mouseY, boolean hovered, float deltaTicks) {
                context.drawTextWithShadow(((DetailsScreen)DetailsScreen.this).client.textRenderer, this.displayName, this.getContentX(), this.getContentY(), Colors.WHITE);
                this.multilineDetails.draw(context, MultilineText.Alignment.LEFT, this.getContentX(), this.getContentY() + 12, ((DetailsScreen)DetailsScreen.this).textRenderer.fontHeight, true, -1);
            }
