...
extends Screen {
    ...
    protected void init() {
        ...
        lv.add(ButtonWidget.builder(ATTRIBUTION_TEXT, ConfirmLinkScreen.opening((Screen)this, Urls.JAVA_ATTRIBUTION)).width(210).build());
        lv.add(ButtonWidget.builder(LICENSE_TEXT, ConfirmLinkScreen.opening((Screen)this, Urls.JAVA_LICENSES)).width(210).build());
