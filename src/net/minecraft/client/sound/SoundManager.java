...
extends SinglePreparationResourceReloader<SoundList> {
    ...
    private static final Gson GSON = new GsonBuilder().registerTypeAdapter((Type)((Object)SoundEntry.class), new SoundEntryDeserializer()).create();
    ...
    public void updateSoundVolume(SoundCategory arg) {
        this.soundSystem.updateSoundVolume(arg);
    }
