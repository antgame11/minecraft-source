...
extends AnimatedParticle {
    ...
    implements ParticleFactory<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType arg, ClientWorld arg2, double d, double e, double f, double g, double h, double i, Random arg3) {
            return new SquidInkParticle(arg2, d, e, f, g, h, i, ColorHelper.fromFloats(1.0f, 0.2f, 0.8f, 0.6f), this.spriteProvider);
        }
    }
    ...
    implements ParticleFactory<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType arg, ClientWorld arg2, double d, double e, double f, double g, double h, double i, Random arg3) {
            return new SquidInkParticle(arg2, d, e, f, g, h, i, -16777216, this.spriteProvider);
        }
    }
}
