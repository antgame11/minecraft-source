...
extends BillboardParticle {
    ...
    implements ParticleFactory<TrailParticleEffect> {
        ...
        @Override
        public Particle createParticle(TrailParticleEffect arg, ClientWorld arg2, double d, double e, double f, double g, double h, double i, Random arg3) {
            TrailParticle lv = new TrailParticle(arg2, d, e, f, g, h, i, arg.target(), arg.color(), this.spriteProvider.getSprite(arg3));
