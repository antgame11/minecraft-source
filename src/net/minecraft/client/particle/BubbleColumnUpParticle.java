...
extends BillboardParticle {
    BubbleColumnUpParticle(ClientWorld arg, double d, double e, double f, double g, double h, double i, Sprite arg2) {
    ...
    implements ParticleFactory<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType arg, ClientWorld arg2, double d, double e, double f, double g, double h, double i, Random arg3) {
            BubbleColumnUpParticle lv = new BubbleColumnUpParticle(arg2, d, e, f, g, h, i, this.spriteProvider.getSprite(arg3));
            return lv;
        }
    }
}
