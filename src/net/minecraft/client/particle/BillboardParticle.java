...
extends Particle {
    ...
    protected void render(BillboardParticleSubmittable submittable, Camera camera, Quaternionf rotation, float tickProgress) {
        ...
        float g = (float)(MathHelper.lerp((double)tickProgress, this.lastX, this.x) - lv.getX());
        float h = (float)(MathHelper.lerp((double)tickProgress, this.lastY, this.y) - lv.getY());
        float i = (float)(MathHelper.lerp((double)tickProgress, this.lastZ, this.z) - lv.getZ());
    ...
    public static interface Rotator {
        public static final Rotator ALL_AXIS = (quaternion, camera, tickProgress) -> quaternion.set(camera.getRotation());
