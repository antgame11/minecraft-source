...
extends BillboardParticle {
    ...
    implements ParticleFactory<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType arg, ClientWorld arg2, double d, double e, double f, double g, double h, double i, Random arg3) {
            ...
            int j = 10;
            int k = 40;
            lv.setMaxAge(arg3.nextInt(30) + 10);
            return lv;
        }
    }
    ...
    implements ParticleFactory<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType arg, ClientWorld arg2, double d, double e, double f, double g, double h, double i, Random arg3) {
            GlowParticle lv = new GlowParticle(arg2, d, e, f, 0.5 - arg3.nextDouble(), h, 0.5 - arg3.nextDouble(), this.spriteProvider);
            if (arg3.nextBoolean()) {
            ...
            lv.setMaxAge((int)(8.0 / (arg3.nextDouble() * 0.8 + 0.2)));
            return lv;
        }
    }
}
