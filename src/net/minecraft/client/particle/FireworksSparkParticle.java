...
public class FireworksSparkParticle {
    ...
    implements ParticleFactory<TintedParticleEffect> {
        ...
        public Particle createParticle(TintedParticleEffect arg, ClientWorld arg2, double d, double e, double f, double g, double h, double i, Random arg3) {
            Flash lv = new Flash(arg2, d, e, f, this.spriteProvider.getSprite(arg3));
    ...
    extends BillboardParticle {
        Flash(ClientWorld arg, double d, double e, double f, Sprite arg2) {
    ...
    extends NoRenderParticle {
        ...
        public void tick() {
            ...
            if (this.age == 0) {
                ...
                this.world.playSoundClient(this.x, this.y, this.z, lv2, SoundCategory.AMBIENT, 20.0f, 0.95f + this.random.nextFloat() * 0.1f, true);
            }
            ...
            if (this.age > this.maxAge) {
                if (this.flicker) {
                    bl = this.isFar();
                    SoundEvent lv4 = bl ? SoundEvents.ENTITY_FIREWORK_ROCKET_TWINKLE_FAR : SoundEvents.ENTITY_FIREWORK_ROCKET_TWINKLE;
                    this.world.playSoundClient(this.x, this.y, this.z, lv4, SoundCategory.AMBIENT, 20.0f, 0.9f + this.random.nextFloat() * 0.15f, true);
                }
                this.markDead();
            }
        }
