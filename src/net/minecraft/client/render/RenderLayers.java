...
public class RenderLayers {
    private static final Map<Block, BlockRenderLayer> BLOCKS = Util.make(Maps.newHashMap(), map -> {
        BlockRenderLayer lv = BlockRenderLayer.TRIPWIRE;
        map.put(Blocks.TRIPWIRE, lv);
        BlockRenderLayer lv2 = BlockRenderLayer.CUTOUT_MIPPED;
        map.put(Blocks.GRASS_BLOCK, lv2);
        map.put(Blocks.IRON_BARS, lv2);
        Blocks.COPPER_BARS.forEach(arg2 -> map.put(arg2, lv2));
        map.put(Blocks.GLASS_PANE, lv2);
        map.put(Blocks.TRIPWIRE_HOOK, lv2);
        map.put(Blocks.HOPPER, lv2);
        map.put(Blocks.IRON_CHAIN, lv2);
        Blocks.COPPER_CHAINS.forEach(arg2 -> map.put(arg2, lv2));
        ...
        BlockRenderLayer lv3 = BlockRenderLayer.CUTOUT;
        ...
        map.put(Blocks.BUSH, lv3);
        map.put(Blocks.DEAD_BUSH, lv3);
        map.put(Blocks.SHORT_DRY_GRASS, lv3);
        map.put(Blocks.TALL_DRY_GRASS, lv3);
        ...
        map.put(Blocks.COPPER_TORCH, lv3);
        map.put(Blocks.COPPER_WALL_TORCH, lv3);
        ...
        Blocks.COPPER_LANTERNS.forEach(arg2 -> map.put(arg2, lv3));
        ...
        map.put(Blocks.WILDFLOWERS, lv3);
        map.put(Blocks.LEAF_LITTER, lv3);
        ...
        map.put(Blocks.FIREFLY_BUSH, lv3);
        map.put(Blocks.CACTUS_FLOWER, lv3);
        BlockRenderLayer lv4 = BlockRenderLayer.TRANSLUCENT;
    ...
    public static BlockRenderLayer getBlockLayer(BlockState state) {
        ...
        BlockRenderLayer lv2 = BLOCKS.get(lv);
        if (lv2 != null) {
            return lv2;
        }
    ...
    public static RenderLayer getEntityBlockLayer(BlockState state) {
        BlockRenderLayer lv = RenderLayers.getBlockLayer(state);
        if (lv == BlockRenderLayer.TRANSLUCENT) {
    ...
    public static BlockRenderLayer getFluidLayer(FluidState state) {
        BlockRenderLayer lv = FLUIDS.get(state.getFluid());
        if (lv != null) {
            return lv;
        }
        return BlockRenderLayer.SOLID;
