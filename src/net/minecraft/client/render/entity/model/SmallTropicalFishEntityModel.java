...
extends EntityModel<TropicalFishEntityRenderState> {
    ...
    public static TexturedModelData getTexturedModelData(Dilation dilation) {
        ...
        int i = 22;
        lv2.addChild(EntityModelPartNames.BODY, ModelPartBuilder.create().uv(0, 0).cuboid(-1.0f, -1.5f, -3.0f, 2.0f, 3.0f, 6.0f, dilation), ModelTransform.origin(0.0f, 22.0f, 0.0f));
        lv2.addChild(EntityModelPartNames.TAIL, ModelPartBuilder.create().uv(22, -6).cuboid(0.0f, -1.5f, 0.0f, 0.0f, 3.0f, 6.0f, dilation), ModelTransform.origin(0.0f, 22.0f, 3.0f));
        ...
        lv2.addChild(EntityModelPartNames.TOP_FIN, ModelPartBuilder.create().uv(10, -5).cuboid(0.0f, -3.0f, 0.0f, 0.0f, 3.0f, 6.0f, dilation), ModelTransform.origin(0.0f, 20.5f, -3.0f));
