...
public interface Scaling {
    ...
    {
        public static final MapCodec<NineSlice> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)Codecs.POSITIVE_INT.fieldOf("width")).forGetter(NineSlice::width), ((MapCodec)Codecs.POSITIVE_INT.fieldOf("height")).forGetter(NineSlice::height), ((MapCodec)Border.CODEC.fieldOf("border")).forGetter(NineSlice::border), Codec.BOOL.optionalFieldOf("stretch_inner", false).forGetter(NineSlice::stretchInner)).apply((Applicative<NineSlice, ?>)instance, NineSlice::new)).validate(NineSlice::validate);
        ...
        public record Border(int left, int top, int right, int bottom) {
            ...
            private static final Codec<Border> DIFFERENT_SIDE_SIZES_CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)Codecs.NON_NEGATIVE_INT.fieldOf("left")).forGetter(Border::left), ((MapCodec)Codecs.NON_NEGATIVE_INT.fieldOf("top")).forGetter(Border::top), ((MapCodec)Codecs.NON_NEGATIVE_INT.fieldOf("right")).forGetter(Border::right), ((MapCodec)Codecs.NON_NEGATIVE_INT.fieldOf("bottom")).forGetter(Border::bottom)).apply((Applicative<Border, ?>)instance, Border::new));
