...
public abstract class BlockStateVariantMap<V> {
    ...
    protected void register(PropertiesMap properties, V variant) {
        V object2 = this.variants.put(properties, variant);
        if (object2 != null) {
    ...
    extends BlockStateVariantMap<V> {
        ...
        public SingleProperty<V, T1> register(T1 property, V variant) {
            PropertiesMap lv = PropertiesMap.withValues(this.property.createValue(property));
            this.register(lv, variant);
            return this;
        }
    ...
    extends BlockStateVariantMap<V> {
        ...
        public DoubleProperty<V, T1, T2> register(T1 firstProperty, T2 secondProperty, V variant) {
            PropertiesMap lv = PropertiesMap.withValues(this.first.createValue(firstProperty), this.second.createValue(secondProperty));
            this.register(lv, variant);
            return this;
        }
    ...
    extends BlockStateVariantMap<V> {
        ...
        public TripleProperty<V, T1, T2, T3> register(T1 firstProperty, T2 secondProperty, T3 thirdProperty, V variant) {
            PropertiesMap lv = PropertiesMap.withValues(this.first.createValue(firstProperty), this.second.createValue(secondProperty), this.third.createValue(thirdProperty));
            this.register(lv, variant);
            return this;
        }
    ...
    extends BlockStateVariantMap<V> {
        ...
        public QuadrupleProperty<V, T1, T2, T3, T4> register(T1 firstProperty, T2 secondProperty, T3 thirdProperty, T4 fourthProperty, V variant) {
            PropertiesMap lv = PropertiesMap.withValues(this.first.createValue(firstProperty), this.second.createValue(secondProperty), this.third.createValue(thirdProperty), this.fourth.createValue(fourthProperty));
            this.register(lv, variant);
            return this;
        }
    ...
    extends BlockStateVariantMap<V> {
        ...
        public QuintupleProperty<V, T1, T2, T3, T4, T5> register(T1 firstProperty, T2 secondProperty, T3 thirdProperty, T4 fourthProperty, T5 fifthProperty, V variant) {
            PropertiesMap lv = PropertiesMap.withValues(this.first.createValue(firstProperty), this.second.createValue(secondProperty), this.third.createValue(thirdProperty), this.fourth.createValue(fourthProperty), this.fifth.createValue(fifthProperty));
            this.register(lv, variant);
            return this;
        }
