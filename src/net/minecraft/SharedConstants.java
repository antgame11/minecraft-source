...
public class SharedConstants {
    ...
    @Deprecated
    public static final int RELEASE_TARGET_PROTOCOL_VERSION = 773;
    @Deprecated
    public static final int field_29736 = 274;
    public static final int SNBT_TOO_OLD_THRESHOLD = 4531;
    private static final int field_29708 = 30;
    public static final boolean CRASH_ON_UNCAUGHT_THREAD_EXCEPTION = false;
    @Deprecated
    public static final int RESOURCE_PACK_VERSION = 69;
    @Deprecated
    public static final int field_61077 = 0;
    @Deprecated
    public static final int DATA_PACK_VERSION = 88;
    @Deprecated
    public static final int field_61078 = 0;
    @Deprecated
    ...
    public static final String field_62277 = "1.0.0";
    ...
    public static final boolean WATER = SharedConstants.debugProperty("WATER");
    public static final boolean HEIGHTMAP = SharedConstants.debugProperty("HEIGHTMAP");
    public static final boolean COLLISION = SharedConstants.debugProperty("COLLISION");
    ...
    public static final boolean SUPPORT_BLOCKS = SharedConstants.debugProperty("SUPPORT_BLOCKS");
    ...
    public static final boolean LIGHT = SharedConstants.debugProperty("LIGHT");
    public static final boolean SKY_LIGHT_SECTIONS = SharedConstants.debugProperty("SKY_LIGHT_SECTIONS");
    public static final boolean SOLID_FACE = SharedConstants.debugProperty("SOLID_FACE");
    public static final boolean CHUNKS = SharedConstants.debugProperty("CHUNKS");
    ...
    private static boolean debugProperty(String name) {
        ...
        String string2 = SharedConstants.getDebugPropertyName(name);
        if (DEBUG_PRINT_PROPERTIES) {
            System.out.println("Debug property available: " + string2 + ": bool");
        }
        return SharedConstants.propertyIsSet(string2);
    }
