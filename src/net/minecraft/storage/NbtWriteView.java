...
implements WriteView {
    ...
    public <T> void put(String key, Codec<T> codec, T value) {
        DataResult<NbtElement> dataResult = codec.encodeStart(this.ops, (NbtElement)value);
        Objects.requireNonNull(dataResult);
        DataResult<NbtElement> dataResult2 = dataResult;
        int n = 0;
        switch (SwitchBootstraps.typeSwitch("typeSwitch", new Object[]{DataResult.Success.class, DataResult.Error.class}, dataResult2, n)) {
            default: {
    ...
    public <T> void put(MapCodec<T> codec, T value) {
        DataResult<NbtElement> dataResult = codec.encoder().encodeStart(this.ops, value);
        Objects.requireNonNull(dataResult);
        DataResult<NbtElement> dataResult2 = dataResult;
        int n = 0;
        switch (SwitchBootstraps.typeSwitch("typeSwitch", new Object[]{DataResult.Success.class, DataResult.Error.class}, dataResult2, n)) {
    ...
    public WriteView get(String key) {
        ...
        this.nbt.put(key, lv);
        return new NbtWriteView(this.makeChildReporter(key), this.ops, lv);
    }
    ...
    public WriteView.ListView getList(String key) {
        ...
        this.nbt.put(key, lv);
        return new NbtListView(key, this.reporter, this.ops, lv);
    }
    ...
    public <T> WriteView.ListAppender<T> getListAppender(String key, Codec<T> codec) {
        NbtList lv = new NbtList();
        this.nbt.put(key, lv);
        return new NbtListAppender<T>(this.reporter, key, this.ops, codec, lv);
    }
    ...
    implements WriteView.ListView {
        ...
        public WriteView add() {
            ...
            NbtCompound lv = new NbtCompound();
            this.list.add(lv);
            return new NbtWriteView(this.reporter.makeChild(new ErrorReporter.NamedListElementContext(this.key, i)), this.ops, lv);
        }
    ...
    implements WriteView.ListAppender<T> {
        ...
        public void add(T value) {
            DataResult<NbtElement> dataResult = this.codec.encodeStart(this.ops, (NbtElement)value);
            Objects.requireNonNull(dataResult);
            DataResult<NbtElement> dataResult2 = dataResult;
            int n = 0;
            switch (SwitchBootstraps.typeSwitch("typeSwitch", new Object[]{DataResult.Success.class, DataResult.Error.class}, dataResult2, n)) {
