...
extends LeafEntry {
    public static final MapCodec<ItemEntry> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)Item.ENTRY_CODEC.fieldOf("name")).forGetter(entry -> entry.item)).and(ItemEntry.addLeafFields(instance)).apply(instance, ItemEntry::new));
