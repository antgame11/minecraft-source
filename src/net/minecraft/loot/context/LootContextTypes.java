...
public class LootContextTypes {
    ...
    public static final ContextType ENTITY_INTERACT = LootContextTypes.register("entity_interact", arg -> arg.require(LootContextParameters.TARGET_ENTITY).allow(LootContextParameters.INTERACTING_ENTITY).require(LootContextParameters.TOOL));
    public static final ContextType BLOCK_INTERACT = LootContextTypes.register("block_interact", arg -> arg.require(LootContextParameters.BLOCK_STATE).allow(LootContextParameters.BLOCK_ENTITY).allow(LootContextParameters.INTERACTING_ENTITY).allow(LootContextParameters.TOOL));
